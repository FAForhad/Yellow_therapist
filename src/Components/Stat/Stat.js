  ...
  return (
    <div>
      <div className="xl:px-20 px-6 py-20 xl:mx-auto xl:container">
        <h1 className="xl:text-5xl md:text-4xl text-2xl leading-tight text-center text-yellow-300 sm:mb-0 mb-12">
        ...
        <div className="md:mt-14 mt-4 relative sm:flex items-center justify-center">
          <img
            ...
            alt="world map image"
            className="w-full  h-96 object-cover object-fill sm:block hidden"
          />
          <img
          ...
          />
          <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-yellow-50 sm:absolute relative z-20 sm:mt-0 mt-4 left-0 xl:ml-56 sm:ml-12 xl:-mt-40 sm:-mt-12">
          ...
          <div className="shadow-lg xl:p-6 p-4 w-48 sm:w-auto w-full bg-yellow-50 sm:absolute relative z-20 sm:mt-0 mt-4 xl:mt-80 sm:mt-56 xl:-ml-0 sm:-ml-12">
          ...
          <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-yellow-50 sm:absolute relative z-20 md:mt-0 sm:-mt-5 mt-4 right-0 xl:mr-56 sm:mr-24">
